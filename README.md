...
| ![cube](docs/assets/modes/png/cube.png) Cube | ![arc](docs/assets/modes/png/arc.png) Arc | ![array](docs/assets/modes/png/array.png) Array | ![slope](docs/assets/modes/png/slope_floor.png) Slope |
